...
############################# CHANGE THESE###############################
	...
	cluster_templates = np.load("Syn5/syn5_dba_templates.npy")
#########################################################################
...
############################# CHANGE THESE###############################
	...
	np.save("dist/syn5_distance_dba_test"+str(num)+".npy",distancefeatures)
...
############################# CHANGE THESE###############################
	...
	np.save("dist/syn5_distance_dba_train"+str(num)+".npy",distancefeatures)
#########################################################################
	'''
	for k in range(len(test_labels)):
	    if test_labels[k]>2:
