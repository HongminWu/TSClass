...
plot.plot_raw("MotionData2/xTrain.npy", "MotionData2/yTrain.npy", "OR", 20)
plot.plot_raw("MotionData2/xTrainF.npy", "MotionData2/yTrainF.npy", "FL", 20)
plot.plot_raw("MotionData2/xTrainC.npy", "MotionData2/yTrainC.npy", "SP", 20)
