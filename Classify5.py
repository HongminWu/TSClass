...
### FILE 5: DBA template original 0.25
...
############################# CHANGE THESE###############################
	...
	np.save("dist/syn5_distance_dba_original0.25_test"+str(num)+".npy",distancefeatures)
...
############################# CHANGE THESE###############################
	...
	np.save("dist/syn5_distance_dba_original0.25_train"+str(num)+".npy",distancefeatures)
#########################################################################
	'''
	for k in range(len(test_labels)):
	    if test_labels[k]>2:
