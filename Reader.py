...
def combineNPY(files):
	...
	np.save("distances_hclust_mindist_average_new_dist_train_all.npy",bigarray)
	return bigarray	
...
files = ["distances_hclust_mindist_average_new_dist_train1.npy", "distances_hclust_mindist_average_new_dist_train2.npy", "distances_hclust_mindist_average_new_dist_train3.npy", "distances_hclust_mindist_average_new_dist_train4.npy", "distances_hclust_mindist_average_new_dist_train5.npy"]
combineNPY(files)
