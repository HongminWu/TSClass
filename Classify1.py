...
dist_clusts = np.load("Syn5/syn5_dist_cluster_original0.25.npy")
clusters = np.load("Syn5/syn5_cluster_original0.25.npy")
cluster_labels = np.load("Syn5/syn5_ycluster_original0.25.npy")
...
############################# CHANGE THESE###############################
	...
	# cluster_templates = np.load("Syn5/syn5_dba_templates_original0.25.npy")
#########################################################################
...
############################# CHANGE THESE###############################
	...
	np.save("dist/syn5_distance_original0.25_test"+str(num)+".npy",distancefeatures)
...
############################# CHANGE THESE###############################
	...
	np.save("dist/syn5_distance_original0.25_train"+str(num)+".npy",dist_features_train)
#########################################################################
	'''
	for k in range(len(test_labels)):
	    if test_labels[k]>2:
